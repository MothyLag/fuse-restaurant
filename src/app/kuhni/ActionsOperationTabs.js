...
const useActionNew = async (baseUrl, moduleName, operationName, newData) => {
	const url = `${baseUrl}/api/modules/module/${moduleName}/v1/operation/${operationName}/new`;
...
const useActionUpdate = async (baseUrl, moduleName, operationName, newData) => {
	const url = `${baseUrl}/api/modules/module/${moduleName}/v1/operation/${operationName}/record/${newData.id}/update`;
...
const useActionDelete = async (baseUrl, moduleName, operationName, newData) => {
	const url = `${baseUrl}/api/modules/module/${moduleName}/v1/operation/${operationName}/record/${newData.id}/delete`;
...
const useActionRemove = async (baseUrl, moduleName, operationName, newData) => {
	const url = `${baseUrl}/api/modules/module/${moduleName}/v1/operation/${operationName}/record/${newData.id}/remove`;
...
const useOperationSchema = (baseUrl, moduleName, operationName) => {
	const url = `${baseUrl}/api/modules/module/${moduleName}/v1/operation/${operationName}/schema`;
