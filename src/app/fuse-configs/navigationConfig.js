		...
		children: [
			{
				...
				type: 'item',
				icon: 'list',
				url: '/dev/right-sidebar-2-tabbed'
			},
			{
				id: 'module-operations',
				title: 'Módulo con Operaciones',
				type: 'item',
				icon: 'list',
				url: '/dev/module-operations'
			}
		]
	},
	{
