		...
		<FusePageSimple
			...
			content={
				<div className="p-24 max-w-2xl">
					...
					<Typography className="mb-16" component="p">
						HOCs are needed for formsy to work. We created for TextField, Select, RadioGroup, Checkbox under
						@fuse.
					</Typography>
					...
					<FuseExample
						className="mb-64"
						component={require('./examples/Demo.js').default}
						raw={require('!raw-loader!./examples/Demo.js')}
					/>
