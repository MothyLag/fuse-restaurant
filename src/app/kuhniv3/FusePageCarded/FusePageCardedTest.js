...
const FusePageCardedTest = React.forwardRef((props, ref) => {
		...
		<div className={clsx(classes.root, props.innerScroll && classes.innerScroll)} ref={rootRef}>
			...
			<div className="flex container w-full">
				...
				>
					...
					>
						{props.content && (
							<div className={clsx(props.contentCard && props.innerScroll && 'inner-scroll mr-2')}>
								{props.content && props.content}
							</div>
						)}

						{props.rightContent && (
							<div className={clsx(props.contentCard && props.innerScroll && 'inner-scroll')}>
...
FusePageCardedTest.defaultProps = {};

export default React.memo(FusePageCardedTest);
